...
- **サイズ記号の読み方**（先方回答 2026-09-18: F＝フリーサイズ、TTT＝丈。身長との対応は表の参考身長から）: 数字＝号数相当、F＝サイズフリー（寸法を範囲で合わせる）、T の数＝身長の段階（T=160cm・TT=165cm・TTT=170cm）。判定は 160cm の行で行い、身長から段階を決める（`AY.dressHeightTiers`。ちょうど中間は低い方）

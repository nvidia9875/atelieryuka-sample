...
(function () {
  ...
  /* data-catalog の付いたボタンはどれもビューアを開く */
  Array.prototype.forEach.call(document.querySelectorAll("[data-catalog]"), function (btn) {
    btn.addEventListener("click", function () { window.AYCatalog.open(); });
  });
})();
